(function() {
  ...
  var Decode = (function() {
    ...
    incrementCounter = function( lastIdx ) {
      console.log( lastIdx + 1);
      return counter = lastIdx + 1; // + 1 because we want to start at the next obj
    }
    ...
    getString = function() {
      ...
      // pass the index of where we cut the string to the incrementCounter function
      // + 1 because we need to include the length (1) of the colon (':')
